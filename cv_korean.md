...
## 프로젝트 (Projects)
- **2026** **자유시점 미디어 압축, 복원, 렌더링 기술개발**
  - 과학기술정보통신부 정보통신기획평가원
  - 사업규모: 4년 45억 원
  - 4D 가우시안 스플래팅 제작 및 압축, 복원, 렌더링 기술개발
- **2026** **복합 생성형 딥페이크 대응을 위한 능동 탐지-심층 분석 솔루션 개발** (AEGIS: Agentic Experts for Generative-AI Inspection Solution)
  - 과학기술정보통신부 정보통신기획평가원
  - 사업규모: 4년 75억 원
  - 복합 생성형 딥페이크 탐지 및 분석 솔루션 개발
- **2026** **뇌파와 연동되는 마인드 프롬프팅 에이전트 기술 개발**
  - 과학기술정보통신부 정보통신기획평가원
  - 사업규모: 3년 56억 원
  - EEG 등 뇌파 신호에 기반한 이미지 및 영상의 심상 생성 연구
- **2025** **역사적 데이터 기반 디지털 휴먼 자동 생성 기술 개발**
  - 문화체육관광부 한국콘텐츠진흥원
  - 사업규모: 3년 27.3억 원
  - 역사적 사료에 기반한 과거 인물에 대한 디지털 휴먼 생성 및 컨트롤 기술 개발
...
## 특허 (Patents)
- **2025** **자연스러운 머리 움직임을 보존한 4D 메쉬 시퀀스 편집을 통한 디지털 영상 생성 방법** (한국, 등록번호 10-2968982)
- **2023** **풀바디 스캔과 모션 캡처를 활용한 3D 애니메이션 바디 프로필 제작 방법** (한국, 등록번호:10-2805326)
- **2015** **리깅 공간으로의 몸체 동작 리타겟팅** (한국, 등록번호: 10-1686028)
- **2009** **대상의 특성에 기반한 얼굴 애니메이션 전달 기술** (한국, 등록번호: 10-1261737)

## 주요 작품 (Film and Animation Credits)
- **프로젝트Y**(2025), **하이파이브**(2025), **지옥**(2021), **안시성**(2018), **염력**(2018), **군함도**(2017) 등 영화 및 TV 시리즈 다수
- **2009** [**The Life**](https://youtu.be/w3VesG0GHW8) - 전체 캐릭터 애니메이션, 프랍 모델링 담당. 대한민국 영상대전 학생부문 대상 등 다수 초청/수상
