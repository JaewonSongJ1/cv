...
## Personal Profile
I conduct computer graphics R&D related to digital characters used in film CG VFX and animation production. I primarily develop in-house solutions related to motion capture and character rigging, as well as machine learning-based solutions to streamline and automate production workflows.

## Interests
- Motion Capture / Facial Capture and Retargeting
- Mesh Scanning and Facial Rigging for High-Quality Facial Production
- Machine Learning-based Production Automation and Efficiency

## Experience & Education
- **2023-Pres.** Adjunct Professor, Graduate School of Film and Digital Media, Hongik University
- **2023-Pres.** Director of R&D, Dexter Studios Inc.
...
- **2016 Jun.** **Direct Retargeting Method from Facial Capture Data to Facial Rig.** Jaewon Song, Junyong Noh. *Journal of the Korea Computer Graphics Society, Volume 22, No.2, June 2016*
- **2016 Jan.** **A Study on Optical Motion Capture Process of Quadruped Animals and Motion Retargeting Pipeline of Quadruped Characters.** Jaewon Song, Mi You, Junghee Kim, Junsik Yang, Junyong Noh. *Journal of The Animation Society of Korea, Vol.11, No.5, pp.162-179, 2016*
...
- **2015** [**Pipeline Technical Development for Stylized Animation Production based on Motion Capture**](https://www.youtube.com/watch?v=fYPcPxdI_LY)
  - Funding Agency: Daejeon Information and Culture Industry Promotion Agency (DICA)
...
- **2014** [**Photo-projection Mattepainting Toolkit Development**](http://vml.kaist.ac.kr/projects/tech/2014/2014Photomapping_DI.html)
  - Funding Agency: Digital Idea
  - Developed V-ray shader for HDRI photo projection mapping
- **2012** [**Facial and Body Animation Tool Development**](http://vml.kaist.ac.kr/projects/tech/2012/2012MohmAndNaht.html)
  - Funding Agency: Studio KAI
  - Developed custom rig controller retargeting and pose library tools
...
**In-house Software Plugin Development**
- Python, QT - Maya Python API, PyQT UI Design, PyMel
- C++ - Maya API, Shader Programming
- C# - Unity3D Plugin

**Softwares**
- Autodesk Maya, Autodesk MotionBuilder, Blender - Animating, Rigging, Motion Retargeting and Editing
- Vicon Blade, Vicon Cara, Faceware - Motion capture and data handling
- Unity, Unreal, Godot - Game engine for real-time production
